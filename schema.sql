...
CREATE TABLE neurotransmitter_profiles
                             (
                                 id                        INTEGER PRIMARY KEY AUTOINCREMENT,
                                 patient_id                INTEGER,
                                 session_id                INTEGER,
...
CREATE TABLE longitudinal_analysis
                       (
                           id
                           INTEGER
                           PRIMARY
...
CREATE INDEX idx_analysis_method ON analysis_results(analysis_method);
CREATE INDEX idx_longitudinal_patient ON longitudinal_analysis(patient_id);
CREATE INDEX idx_insights_type ON research_insights(insight_type);
...
CREATE TABLE testing_system_parameters
                       (
                           id
                           INTEGER
                           PRIMARY
